...
class Rob6323Go2Env(DirectRLEnv):
    ...
    def _setup_scene(self):
        ...
        self.scene.sensors["contact_sensor"] = self._contact_sensor # <--- ADD THIS LINE PSSSS
        # add lights
    ...
    def _get_foot_placement_rew(self):
        ...
        # self_collision_force=torch.norm(self._contact_sensor.data.net_forces_w[:, self._undesired_contact_body_ids, :], dim=-1)
        # desired_collision
